...
const PQ_CRITERIA = {
    ...
    financial: {
        ...
        items: {
            ...
            financialReadiness: {
                title: 'ความพร้อมด้านการเงิน (สินทรัพย์หมุนเวียน - หนี้สินหมุนเวียน)',
                weight: 0.10,
                levels: [
                    { score: 5, text: 'มากกว่า 200.0 ล้านบาท' }, { score: 4, text: 'ตั้งแต่ 50.0 - 200.0 ล้านบาท' },
                    { score: 3, text: 'ตั้งแต่ 5.0 - 50.0 ล้านบาท' }, { score: 2, text: 'ตั้งแต่ 1.0 - 5.0 ล้านบาท' },
                    { score: 1, text: 'ตั้งแต่ 0.5 - 1.0 ล้านบาท' }, { score: 0, text: 'ไม่เกิน 0.5 ล้านบาท' }
                ],
                getScore: (val) => {
